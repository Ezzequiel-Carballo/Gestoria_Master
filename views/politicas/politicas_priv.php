<div class="politics">
    ...
    <div class="caje_politic">
        ...
        <div class="body_politic">
            <div class="caje">
                <h3>
                    El Titular le informa sobre su Política de Privacidad respecto del tratamiento y protección de los datos de carácter personal de los usuarios que puedan ser recabados durante la navegación a través del Sitio Web: https://www.autocorp.com.ar
                </h3>
                <h3>
                ...
                <h3>
                    Para ejercitar sus derechos tiene que enviar su petición junto con una fotocopia del Documento Nacional de Identidad o equivalente a la dirección de correo electrónico: info@autocorp.com.ar
                </h3>
                <h3>
                ...
                <p>Para garantizar el cumplimiento de las condiciones recogidas en la ley aplicable. Esto puede incluir el desarrollo de herramientas y algoritmos que ayuden al Sitio Web a garantizar la confidencialidad de los datos personales que recoge.
                ...
                <h3>
                    El sitio Web está alojado en: Dattatec. La seguridad de los datos está garantizada, ya que toman todas las medidas de seguridad necesarias para ello. Puede consultar su política de privacidad para tener más información.
                </h3>
                <h3>
                ...
                <h3>La base legal para el tratamiento de sus datos es:</h3>
                <p>El consentimiento del interesado.</p>
                <h2>Categorías de datos personales</h2>
                <h3>Las categorías de datos personales que trata el Titular son:</h3>
                ...
                <h3>Los datos personales proporcionados al Titular se conservarán hasta que solicite su supresión.</h3>
                ...
                <p>Tipos de cookies que utiliza Google</p>
                <p>Cómo utiliza Google las cookies en publicidad.</p>
                ...
                <h3>Para contactar con el Titular, suscribirse a un boletín o realizar comentarios en este sitio Web tiene que aceptar la presente Política de Privacidad.</h3>
                <h2>Cambios en la Política de Privacidad</h2>
                <h3>
                    El Titular se reserva el derecho a modificar la presente Política de Privacidad para adaptarla a novedades legislativas o jurisprudenciales, así como a prácticas de la industria.
                </h3>
                <h3>Estas políticas estarán vigentes hasta que sean modificadas por otras debidamente publicadas.</h3>
            </div>
        </div>
    </div>
</div>